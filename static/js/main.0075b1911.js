        ...
        var l = n(184), u = function (e) {
            ...
            d = function (t) {
                ...
                e.useEffect((function () {
                    ...
                    v.current.pause(), v.current = new Audio("./assets/song/".concat(f[t.songIndex].name, ".flac")), v.current.volume = p, y.current ? (v.current.play(), a(!0), w()) : y.current = !0, a(v.isPlaying)
